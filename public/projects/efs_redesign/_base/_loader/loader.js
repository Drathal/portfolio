...
;(function () {
  ...
  dojo._loadPath = function (
    ...
    var uri =
      (relpath.charAt(0) == '/' || relpath.match(/^\w+:/) ? '' : d.baseUrl) +
      relpath
    try {
  ...
  dojo._loadUriAndCheck = function (
    /*String*/ uri,
    /*String*/ moduleName,
    /*Function?*/ cb
  ) {
  ...
  dojo._loadModule = dojo.require = function (
    /*String*/ moduleName,
  ...
  dojo.moduleUrl = function (/*String*/ module, /*dojo._Url||String*/ url) {
    ...
    if (
      loc.charAt(0) != '/' &&
      (colonIndex == -1 || colonIndex > loc.indexOf('/'))
    ) {
      loc = d.baseUrl + loc
    }
  ...
  define = function (name, deps, def) {
    if (!def) {
      ...
      if (deps) {
        ...
        deps =
          typeof def == 'function'
            ? ['require', 'exports', 'module'].slice(0, def.length)
            : []
      }
