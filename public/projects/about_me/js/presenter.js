...
(function($) {
  ...
  $.presenter = function(element, options) {
    ...
    var setSlide = function(move) {
      ...
      switch (move) {
        ...
        case 'prev':
          ...
          break;
        case 'load':
          if (localStorage && localStorage.getItem('cPage')) {
    ...
    function setDimensions() {
      ...
      // we doesn't want real fill screen
      newwidth = newwidth * 0.93;
      newheight = newheight * 0.93;
     ...
     */
    function fadeInAll() {
      var es = $(".slide.show ." + plugin.settings.animclass);
      $(es).each(function() {
        fadeIn();
      });
    }
     ...
     */
    function fadeOutAll() {
      var es = $(".slide ." + plugin.settings.animshow);
      $(es).each(function() {
        fadeOut();
      });
    }
